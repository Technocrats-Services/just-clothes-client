  ...
  return (
    <>
      ...
      <div className="p-3">
        ...
        <p>
          At JustClothes, accessible from www.justclothes.in, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by JustClothes and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in JustClothes. This
        ...
        <h1>Log Files</h1>
        <p>
          JustClothes follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, JustClothes uses 'cookies'. These cookies are
        ...
        <p>
          ...
          advertising partners of JustClothes. Third-party ad servers or ad
          ...
          on JustClothes, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that JustClothes has no
          access to or control over these cookies that are used by third-party
          advertisers.
        </p>
        <h1>Third Party Privacy Policies</h1>
        <p>
          JustClothes's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          JustClothes does not knowingly collect any Personal Identifiable
