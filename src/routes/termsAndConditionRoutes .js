    ...
    <>
      ...
      <div className="p-3">
        ...
        <p>
          ...
          shall manage your use of our website, JustClothes accessible at
          www.justclothes.in. These Terms will be applied fully and affect to
        ...
        <p>
          Other than the content you own, under these Terms, JustClothes and/or
        ...
        <p>
          ...
          and/or showing any Website material; using this Website in any way
          that is or may be damaging to this Website; using this Website in any
          way that impacts user access to this Website; using this Website
          contrary to applicable laws and regulations, or in any way may cause
          harm to the Website, or to any person or business entity; engaging in
          any data mining, data harvesting, data extracting or any other similar
          activity in relation to this Website; using this Website to engage in
          any advertising or marketing. Certain areas of this Website are
          restricted from being access by you and JustClothes may further
        ...
        <p>
          ...
          JustClothes a non-exclusive, worldwide irrevocable, sub licensable
          ...
          invading any third-party’s rights. JustClothes reserves the right to
        ...
        <h2>No warranties</h2>
        <p>
          This Website is provided "as is," with all faults, and JustClothes
        ...
        <p>
          In no event shall JustClothes, nor any of its officers, directors and
          ...
          under contract. JustClothes, including its officers, directors and
        ...
        <p>
          You hereby indemnify to the fullest extent JustClothes from and
        ...
        <p>
          JustClothes is permitted to revise these Terms at any time as it sees
          fit, and by using this Website you are expected to review these Terms
          on a regular basis.
        </p>
        <h2>Assignment</h2>
        <p>
          The JustClothes is allowed to assign, transfer, and subcontract its
        ...
        <p>
          These Terms constitute the entire agreement between JustClothes and
